...
```
Xfwm4 Theme: RGapsLineNoButtons
...
PS: Snapped windows will have 8-px gaps between eacher other. You may want to set 4-px margins on all screen edges and after the panel/s.
